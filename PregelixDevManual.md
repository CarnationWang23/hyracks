  * [Introduction](http://code.google.com/p/hyracks/wiki/PregelixDevManual#Introduction)
  * [Programming model](http://code.google.com/p/hyracks/wiki/PregelixDevManual#Programming_model)
    * [Vertex](http://code.google.com/p/hyracks/wiki/PregelixDevManual#Vertex)
    * [Message Combiner](http://code.google.com/p/hyracks/wiki/PregelixDevManual#Message_Combiner)
    * [Global Aggregator](http://code.google.com/p/hyracks/wiki/PregelixDevManual#Global_Aggregator)
  * [Implementing the first example](http://code.google.com/p/hyracks/wiki/PregelixDevManual#Implementing_the_first_example)
    * [Development environment](http://code.google.com/p/hyracks/wiki/PregelixDevManual#Development_environment)
    * [Code for the Vertex](http://code.google.com/p/hyracks/wiki/PregelixDevManual#Code_for_the_Vertex)
    * [Code for the Entry](http://code.google.com/p/hyracks/wiki/PregelixDevManual#Code_for_the_Entry)
    * [Example pom](http://code.google.com/p/hyracks/wiki/PregelixDevManual#Example_pom)
  * [Executing the first example](http://code.google.com/p/hyracks/wiki/PregelixDevManual#Executing_the_first_example)
